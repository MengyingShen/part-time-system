      ...
      <main class="container mx-auto py-12">
        <section class="mb-16 text-center">
          ...
          <div class="flex justify-center gap-4">
            ...
            <RouterLink to="/register?role=student">
                以学生身份加入
            </RouterLink>
              </Button>
              <Button size="lg" class="bg-blue-600 hover:bg-blue-700">
            <RouterLink to="/register?role=employer">
                以雇主身份加入
            </RouterLink>
              </Button>
          </div>
          ...
          <div class="grid gap-8 md:grid-cols-3">
            <Card>
              <CardHeader class="text-center">
                <div class="mx-auto mb-4 overflow-hidden h-24 w-24 rounded-full border-2 border-blue-100">
                  <img 
                    src="/1.png" 
                    alt="学生用户"
          ...
          <div class="grid gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <ul class="space-y-2 text-sm text-gray-600">
                <li>
                  <Link to="/about" class="hover:text-blue-600">
                    关于我们
                  </Link>
                </li>
                <li>
                  <Link to="/contact" class="hover:text-blue-600">
                    Contact
                  </Link>
                </li>
                <li>
                  <Link to="/privacy" class="hover:text-blue-600">
                    隐私政策
                  </Link>
                </li>
                <li>
                  <Link to="/terms" class="hover:text-blue-600">
                    服务条款
                  </Link>
                </li>
              </ul>
