...
<div v-if="success" class="mb-4 rounded-md bg-green-50 p-3 text-sm text-green-600">注册成功！正在跳转到登录页面...</div>
...
<form @submit.prevent="handleSubmit">
  ...
  <div class="text-sm text-gray-600">
    已经有账户了吗？
    <RouterLink :to="`/login${role ? `?role=${role}` : ''}`" class="text-blue-600 hover:underline">
      在此登录
    </RouterLink>
  </div>
</CardFooter>
