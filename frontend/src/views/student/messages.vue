        ...
        <div class="overflow-auto h-[calc(100%-60px)]">
          ...
          >
            <div class="relative">
              ...
              <span v-if="conversation.unread" class="h-2 w-2 rounded-full bg-primary absolute -top-1 -right-1"></span>
            </div>
            <div class="flex-1 min-w-0">
              <div class="flex items-center justify-between">
                <h3 class="font-medium">{{ conversation.name }}</h3>
                <span class="text-xs text-muted-foreground">{{ conversation.lastMessageTime }}</span>
              </div>
