...
<template>
  <div class="grid gap-6">
    ...
    <div v-if="isLoading && jobListings.length === 0" class="flex justify-center items-center py-12">
          ...
          <div class="flex justify-between">
            <div>
              <div class="flex items-center gap-2">
                ...
                <Badge v-if="job.salary" variant="outline" class="ml-auto text-green-600 font-medium">
