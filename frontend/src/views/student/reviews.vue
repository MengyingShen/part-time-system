...
const reviews = ref([
  {
    ...
    rating: 5,
    comment:
      '张三是个出色的开发者，展现了扎实的技术基础和快速学习能力。他不仅按时完成了分配的任务，还提出了一些改进网站性能的创新想法。他与团队合作愉快，沟通清晰。非常期待未来能再次合作！',
  ...
  },
  {
    ...
    rating: 4,
    comment:
      '张三工作认真负责，能够按时完成分配的任务。他在整理书籍和帮助读者方面表现出色，展现了良好的服务意识。有时可能需要更加主动一些，但总体表现很好。',
      ...
      <Card>
        ...
        <CardContent>
          <div class="flex items-center gap-4">
            ...
            <div class="text-sm text-muted-foreground">基于{{ reviews.length }}次评价</div>
          </div>
        </CardContent>
      </Card>
