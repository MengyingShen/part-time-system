...
import { Camera, FileText, Save, User } from 'lucide-vue-next'
...
const formData = ref({
  ...
  workHours: '15',
  intro:
    '计算机专业在读学生，拥有良好的编程能力和团队协作精神。熟悉Java、Python、前端开发技术，曾参与多个实践项目。希望通过兼职积累实战经验，为未来职业发展打下基础。',
})
              ...
              <div class="grid gap-2 sm:grid-cols-2 md:grid-cols-3">
                ...
                >
                  <input
                    ...
                    class="h-4 w-4"
                  />
                  <Label :for="'category-' + category" class="text-sm font-normal">{{
                    category
                  }}</Label>
                </div>
              </div>
