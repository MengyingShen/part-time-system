      ...
      <TabsContent value="profile">
        <Card>
          <CardHeader>
            ...
            <CardDescription> 管理您的个人信息，这些信息将显示给潜在雇主 </CardDescription>
          </CardHeader>
          <CardContent class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="space-y-2">
                <Label htmlFor="username">用户名</Label>
                <Input id="username" v-model="profileData.username" />
              </div>
              <div class="space-y-2">
                <Label htmlFor="fullName">姓名</Label>
                <Input id="fullName" v-model="profileData.fullName" />
              </div>
              <div class="space-y-2">
                <Label htmlFor="email">电子邮箱</Label>
                <Input id="email" type="email" v-model="profileData.email" />
              </div>
              <div class="space-y-2">
                <Label htmlFor="phone">电话号码</Label>
                <Input id="phone" v-model="profileData.phone" />
              </div>
              <div class="space-y-2">
                <Label htmlFor="location">所在地</Label>
                <Input id="location" v-model="profileData.location" />
              </div>
            </div>

            <div class="space-y-2">
              <Label htmlFor="bio">个人简介</Label>
              <Textarea id="bio" v-model="profileData.bio" :rows="4" />
            </div>
      ...
      <TabsContent value="notifications">
        <Card>
          <CardHeader>
            ...
            <CardDescription> 管理您希望接收哪些通知以及如何接收 </CardDescription>
          </CardHeader>
            ...
            <div class="space-y-4">
              ...
              <div class="grid gap-4">
                <div class="flex items-center justify-between">
                  ...
                  <Switch id="emailNotifications" v-model:checked="notifications.email" />
                </div>
                <div class="flex items-center justify-between">
                  <div>
                  ...
                  <Switch id="appNotifications" v-model:checked="notifications.app" />
                </div>
              </div>
            </div>
            ...
            <div class="space-y-4">
              ...
              <div class="grid gap-4">
                <div class="flex items-center justify-between">
                  ...
                  <Switch id="newJobs" v-model:checked="notifications.newJobs" />
                </div>
                <div class="flex items-center justify-between">
                  <div>
                ...
                <div class="flex items-center justify-between">
                  ...
                  <Switch id="messages" v-model:checked="notifications.messages" />
                </div>
                <div class="flex items-center justify-between">
                  <div>
                  ...
                  <Switch id="reviews" v-model:checked="notifications.reviews" />
                </div>
              </div>
            </div>
            ...
            <div class="space-y-4">
              ...
              <div class="grid gap-4">
                <div class="space-y-2">
                  ...
                  <Input id="currentPassword" type="password" v-model="security.currentPassword" />
                </div>
                <div class="space-y-2">
                  <Label htmlFor="newPassword">新密码</Label>
                  <Input id="newPassword" type="password" v-model="security.newPassword" />
                </div>
                <div class="space-y-2">
                  <Label htmlFor="confirmPassword">确认新密码</Label>
                  <Input id="confirmPassword" type="password" v-model="security.confirmPassword" />
                </div>
              </div>
              <div class="flex justify-end">
